...
class Products extends Model
{
	...
	public function scopeAddwishlist($query, $getproductid)
	{
		$Pros = $query->where("products_id","=", $getproductid)->get();
	...
	{
		$t_oPro = $query->where('products_id', '=', $v_oId)->select('products_antal')->get();

		$query->where('products_id', '=', $v_oId)->select('products_antal')->update([
