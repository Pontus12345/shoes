	...
	<div id="productpage">
		<div class="center">		
			...
			<table>
				...
				<tr><label for="price"><a class="sort-by" href="http://{{$sHostname}}/Accessories&Products_price">Price</a></label></tr>
				<tr><label for="name"><a class="sort-by" href="http://{{$sHostname}}/Accessories&products_name">Name</a></label></tr>
			</table>
